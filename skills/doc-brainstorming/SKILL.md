...
2. **Ask clarifying questions** — One question at a time, prefer multiple-choice. Cover:
...
| Mistake | Fix |
|---------|-----|
| Asking too many questions at once | One question per message, use multiple-choice |
